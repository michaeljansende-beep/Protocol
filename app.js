...
(() => {
  ...
  async function copyResult() {
    try {
      ...
      // iOS: Clipboard API kann beim Einfügen (Notizen/Mail) anders behandelt werden als manuelles Kopieren.
      // Daher emulieren wir das manuelle Kopieren über Selection + execCommand("copy").
